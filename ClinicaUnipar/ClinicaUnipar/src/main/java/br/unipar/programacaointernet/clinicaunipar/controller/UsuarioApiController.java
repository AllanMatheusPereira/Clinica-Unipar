...
public class UsuarioApiController {
    ...
    @Operation(summary = "Salvar usuário", description = "Salva um novo usuário e retorna o usuário salvo", parameters = {
    @Parameter(name = "usuario", description = "Usuário que será adicionado. " + "Não é necessário incluir o ID.")})
